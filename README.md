...
There is a simple dataset from AIS data, it is prepared to simulate MobilityDB queries. You can find it [here](https://github.com/bouzouidja/MobilityDB-AWS/tree/master/data). You can mount more data in the /mnt/data from host machine to the Cloud in order to test complex analytics queries.  
